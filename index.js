...
const hotDog = new createMenuItem("hot dog", 4, "Lunch"); 
const quesadilla = new createMenuItem("quesadilla", 5, "Breakfast"); 
const smoothie = new createMenuItem("smoothie", 3, "Drinks"); 

console.log(hotDog, quesadilla, smoothie); 
...
reviews.push({name: "Cris", rating: 6, feedback: "This was a horrible place, do not recommend"}); 
